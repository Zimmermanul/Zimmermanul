...
:white_check_mark: [Kotlin android mobile tests on Kaspresso]([https://github.com/Zimmermanul/Allure-GitLab-API-Integration-for-Auto-closing-Defects](https://github.com/Zimmermanul/Android-Kaspresso-Mobile-Tests))
